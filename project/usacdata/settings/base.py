"""
Django settings for usacdata project.
...
EXTERNAL_CONFIG_PATH = '/opt/webapps/usacdata/etc/external_config.py'

# Quick-start development settings1 - unsuitable for production
# See https://docs.djangoproject.com/en/dev/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '4fgor-o3w@f#6sxqt!5zums8-1vn&zr5b@^#y^gka&w!45#i7('
